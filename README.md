...
4. remove old submodule location: `rm -rf .vim` (now lives in `home/.vim`)
5. inspect `install.sh` and `config.js` to make sure all the software you want is installed
6. inspect `home/*` for any changes you want to port from `./dotfiles_old`
...
## iTerm2
- Installing the Dracula theme for iTerm
